...
st.title('📖 Информация о методе прогнозирования')
...
selectbox = st.selectbox(
    "Виды эспоненциального сглаживания: ",
    ("Простое экспоненциальное сглаживание",
     "Сглаживание Хольта",
     "Сглаживание Хольта-Винтерса")
)

if selectbox == "Простое экспоненциальное сглаживание":
...
if selectbox == "Сглаживание Хольта":
...
if selectbox == "Сглаживание Хольта-Винтерса":   
